package net.mewk.selenium.demo.tests.twitter;
...
public class RepositoryTestWin8 {

    private static final Logger LOG = LoggerFactory.getLogger(RepositoryTestWin8.class);
    ...
    public RepositoryTestWin8(String baseUrl, Platform platform, String browserName, String version, String username, String password) {
